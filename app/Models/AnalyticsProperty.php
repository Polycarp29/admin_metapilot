...
class AnalyticsProperty extends Model
{
    ...
    {
        return $this->hasMany(AdCampaign::class, 'analytics_property_id');
    }

    public function seoCampaigns()
    {
        return $this->hasMany(SeoCampaign::class, 'analytics_property_id');
    }

    public function latestSnapshot()
    {
        return $this->hasOne(MetricSnapshot::class, 'analytics_property_id')->latestOfMany();
    }

    public function latestSearchConsoleMetric()
    {
        return $this->hasOne(SearchConsoleMetric::class, 'analytics_property_id')->latestOfMany();
    }
}
